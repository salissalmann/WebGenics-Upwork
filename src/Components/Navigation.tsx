                                ...
                                <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
                                    ...
                                    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-sm justify-center font-nunito">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <div className="absolute hidden  mt-[-0.05rem] space-y-2 w-80  bg-white text-gray-900 group-hover:block rounded-lg border">
                                                <a className="block px-4 py-1 w-80 text-left hover:bg-primary hover:text-white cursor-pointer" onClick={() => { handleOptionSelect('/web-development') }}>Website Development Services</a>
                                                <a className="block px-4 py-1 w-80 hover:bg-primary hover:text-white cursor-pointer" onClick={() => { handleOptionSelect('/mobile-development') }}>Mobile Application Development Services</a>
                                                <a className="block px-4 py-1 w-80 hover:bg-primary hover:text-white cursor-pointer" onClick={() => { handleOptionSelect('/ui-ux') }}>UI/UX Designing Services</a>
                                                <a className="block px-4 py-1 w-80 hover:bg-primary hover:text-white cursor-pointer" onClick={() => { handleOptionSelect('/publication-services') }}>Publication Services</a>
                                                <a className="block px-4 py-1 w-80 hover:bg-primary hover:text-white cursor-pointer overflow-hidden" onClick={() => { handleOptionSelect('/animations') }}>3D/4D Animations</a>
                                            </div>
                                        </div>
                                        <a className="mr-10 text-gray-900 cursor-pointer hover:text-secondary-300"
                                    ...
                                    <button className="inline-flex items-center bg-primary border-0 text-white text-sm py-2 px-4 f rounded-2xl mt-4 md:mt-0"
                                ...
                                " onClick={handleToggleDrawer} />
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col p-3 items-center">
                                            <div className="flex flex-row items-center justify-center gap-2 text-gray-900 font-oxygen font-bold border shadow w-full text-center p-2 border-secondary-300">
                                        ...
                                        {showServices && (
                                            <div className="flex flex-col p-3 items-center mt-1 gap-1">
                                                <div className="text-gray-900 font-oxygen font-bold border shadow w-full text-center p-2 border-secondary-300"
                                                    onClick={() => {
                                                        handleOptionSelect(
                                                            '/web-development'
                                                        )
                                        ...
                                        <div className='flex flex-col p-3 items-center'>
                                            <div className='text-gray-900 font-oxygen bg-primary  font-bold border
