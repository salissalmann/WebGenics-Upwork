                        ...
                        <div className="flex flex-wrap -m-4">
                            <div className="p-4 md:w-1/2 w-full">
                                <div className="h-full bg-gray-100 p-8 rounded flex flex-col justify-between">
                                    ...
                                    <p className="leading-relaxed mb-6 font-nunito text-sm">Working on VidMe has been amazing. They've transformed video job applications with innovation and efficiency. We highly recommend their expertise.</p>
                                    <a className="inline-flex items-center">
                                        ...
                                        <span className="flex-grow flex flex-col pl-4">
                                            <span className="title-font font-medium text-gray-900">Salman Wasay</span>
                                            <span className="text-gray-500 text-sm">CEO - Chai Khanna</span>
                                        </span>
                                    </a>
                                </div>
                            </div>
                            <div className="p-4 md:w-1/2 w-full">
                                <div className="h-full bg-gray-100 p-8 rounded">
                                    ...
                                    <a className="inline-flex items-center">
                                        ...
                                        <span className="flex-grow flex flex-col pl-4">
                                            <span className="title-font font-medium text-gray-900">Fahad Niaz Shiekh</span>
                                            <span className="text-gray-500 text-sm">CFO & CEO PreMed.Pk</span>
                                        </span>
                                    </a>
                                </div>
                            </div>
